...
my_frozenset_4 = my_frozenset_1.intersection(my_frozenset_2)
my_frozenset_5 = my_frozenset_1.difference(my_frozenset_2)
print("Union Result:", my_frozenset_3)
print("Intersection result", my_frozenset_4)
print("Difference result", my_frozenset_5)
